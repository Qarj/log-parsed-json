...
test('should parse a number', () => {
    const result = repairJson('{ "number": 123 }');
...
test('should parse scientific notation without plus', () => {
    const result = repairJson('{ "number": 1.2e9 }');
...
test('should return array of strings and json strings', () => {
    const result = toArrayOfPlainStringsOrJson(
...
test('should return first valid json object', () => {
    const result = firstJson("text before { test: 'test', array: ['test', { test: 'test' }] } text { hey: 1 } after");
    expect(result).toBe('{ "test": "test", "array": ["test", { "test": "test" }] }');
    assertIsJson(result);
});

test('should return last valid json object', () => {
    const result = lastJson("text before { test: 'test', array: ['test', { test: 'test' }] } text { hey: 1 } after");
    expect(result).toBe('{ "hey": 1 }');
    assertIsJson(result);
});

test('should return largest valid json object', () => {
    const result = largestJson(
...
test('should cope with a brace in a string', () => {
    const result = toArrayOfPlainStringsOrJson('real json {"value":["closing brace }"]}');
...
test('should cope with a double quote in string', () => {
    const result = toArrayOfPlainStringsOrJson('real json {"value":["double quote \\"test\\""]}');
    expect(result[0]).toBe('real json ');
...
test('should parse an array of numbers', () => {
    const result = toArrayOfPlainStringsOrJson('real json { "test": [ 1, 2, 3] }');
    expect(result[0]).toBe('real json ');
...
test('should cope with {}', () => {
    const result = toArrayOfPlainStringsOrJson('is json {} abc');
...
test('should cope with all kinds of whitespace', () => {
    ...
    const result = repairJson(jsonWithQuotedWhiteSpace);
    expect(result).toBe('{ "test": 123 }');
    assertIsJson(result);
});
...
test('when changing a single quoted string to double quotes, needs to quote the double quotes', () => {
    ...
    const result = repairJson(scenario);
...
test('should concatenate strings with +', () => {
    ...
    const result = repairJson(object);
...
function assertIsJson(json) {
    ...
    try {
        ...
        if (process.env.LOG_ERRORS) console.log(e);
    }
